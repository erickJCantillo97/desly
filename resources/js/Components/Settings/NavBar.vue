<template>
  <Disclosure as="nav" class="bg-white shadow dark:bg-gray-800 w-screen fixed z-10" v-slot="{ open }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 justify-between">
        ...
        <div class="flex items-center space-x-2">
          ...
          <div v-if="$page.props.auth.user" class="hidden md:ml-4 md:flex md:flex-shrink-0 md:items-center">
