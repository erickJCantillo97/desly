...
<template>
    ...
    <GuesLayout>
        <div id="home" class="relative overflow-hidden bg-primary py-7 h-screen">
            <div class="container">
                <div class="-mx-4 flex flex-wrap items-center">
                    <div class="w-full px-4">
                        <div class="hero-content  mx-auto max-w-[780px] text-center">
                            <h1
                                class="mb-6 text-xl my-12 font-bold leading-snug text-white sm:text-2xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                            ...
                            <ul class="mb-10 flex flex-wrap items-center justify-center gap-5">
                                ...
                                <li>
                                    <v-btn prepend-icon="mdi-progress-download" color="secundary">
                    ...
                    <div class="relative items-center z-10 mx-auto max-w-[845px]">
                        <div class="">
                            <img src="src/img/home/hero-image.jpg" alt="hero"
                                class="mx-auto max-w-full rounded-t-xl rounded-tr-xl" data-aos="flip-down" />
                        </div>
        ...
        <div id="features" class="px-1 md:p-10" data-aos="fade-up">
            <div class="w-full md:mt-10">
                <div class="mx-auto text-center w-full md:w-[40vw]">
                    ...
                    <p class="text-base text-body-color dark:text-dark-6 text-center">
                        Hemos dispuesto este lugar para estar en comunicación contigo, realiza seguimiento a
                        todas tus
                        radicadicaciones en un mismo lugar.
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 px-4 md:px-12 my-12 justify-center">
                <div class="w-full px-4">
                ...
                <div class="w-full px-4">
                    <div class="wow fadeInUp group " data-wow-delay=".2s">
                        <div
                            class="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-primary">
                            <span
                                class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                ...
                <div class="w-full px-4">
                    <div class="wow fadeInUp group" data-wow-delay=".25s">
                        <div
                            class="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-primary">
                            <span
                                class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
