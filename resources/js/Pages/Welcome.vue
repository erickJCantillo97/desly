...
<template>
    ...
    <GuesLayout>
        <div id="home" class="relative overflow-hidden bg-primary py-7" data-aos="fade-up"
            ...
            >
              Gracias a tu opinión mejoraremos 
            </p> -->
        ...
        <section class="px-10 pt-20  lg:pb-[70px] lg:pt-[120px]" data-aos="fade-up"
            data-aos-anchor-placement="center-center">
            <div class="container">
