...
<template>
    ...
    <GuesLayout>
        <div id="home" class="relative overflow-hidden bg-primary py-7">
            <div class="container">
              ...
              Gracias a tu opinión mejoraremos 
                    ...
                    <div class="w-full px-4">
                        ...
                        >
                            <div class="mt-16">
                                <img
                                    src="src/img/home/hero-image.jpg"
                                    alt="hero"
        ...
        <section class="px-10 pt-20 dark:bg-dark lg:pb-[70px] lg:pt-[120px]">
            <div class="container">
                ...
                <div class="w-full px-4">
                  <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                    ...
                    <p class="text-base text-body-color dark:text-dark-6">
                      Hemos dispuesto este lugar  para estar en comunicación contigo, realiza seguimiento a todas tus radicadicaciones en un mismo lugar.
                    </p>
                  </div>
                </div>
              </div>
